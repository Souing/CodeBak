...
namespace Souing.Net.DAL.Base.Service
{
    ...
    public class BaseService<T> : IBaseService<T> where T : BaseClass
    {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public virtual IList<T> GetEntities(Func<T, bool> query)
        {
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public virtual IList<T> GetEntities(PagerInfo pagerInfo, Func<T, string> sortBy, bool isAsc, Func<T, bool> query)
        {
