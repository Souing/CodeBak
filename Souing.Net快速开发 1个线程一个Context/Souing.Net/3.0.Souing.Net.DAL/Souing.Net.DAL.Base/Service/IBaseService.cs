...
namespace Souing.Net.DAL.Base.Service
{
    /// <summary>
    /// 功能描述：IBaseService 
    ...
    public interface IBaseService<T> where T : BaseClass
    {
        ...
        IList<T> GetEntities(Func<T, bool> query);
        ...
        /// <param name="query">lambda查询条件</param>
        /// <returns>返回一个集合</returns>
        IList<T> GetEntities(PagerInfo pagerInfo, Func<T, string> sortBy, bool isAsc, Func<T, bool> query);
        ...
        ///// <returns></returns>
        //IList<T> SqlQuery(string commandText, params  YstDBParameter[] parameters);
