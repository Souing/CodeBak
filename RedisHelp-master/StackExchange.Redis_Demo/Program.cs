...
namespace StackExchange.Redis_Demo
{
    internal class Program
    {
          ...
          private static bool GetType<T>(T value)
          {
              return value is String || value is Int32;
//              return value.GetType().IsPrimitive;
           //   return value.Equals(typeof (String));
        ...
        private static void Main(string[] args)
        {
         ...
         Console.WriteLine(   GetType(12));
            Console.ReadLine();

            RedisHelper redis = new RedisHelper(10);

            for (int i = 0; i < 10; i++)
            {
                Console.WriteLine( redis.StringIncrement("StringIncrement11", 1));
            }
            Console.ReadKey();
            return;
            #region String
